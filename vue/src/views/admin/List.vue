<template>
  <div style="margin-left: 30px">
    ...
    <div style="margin-bottom: 20px;">
      <h2 style="margin-bottom: 30px"><i class="el-icon-admin"></i>管理员</h2>
      <el-input style="width: 240px" placeholder="请输入用户名" v-model="params.username"></el-input>
      <el-input style="width: 240px;margin-left: 5px" placeholder="请输入联系方式" v-model="params.phone"></el-input>
      <el-input style="width: 240px;margin-left: 5px" placeholder="请输入email邮箱" v-model="params.email"></el-input>
...
<!--          scope.row就是当前行数据-->
          ...
          <el-button type="primary" size="mini" @click="$router.push('/editAdmin?id=' + scope.row.id)">编辑<i class="el-icon-edit-outline"></i></el-button>
...
<!--            <el-button  type="warning" @click="handleChangePass">修改密码</el-button>-->
      ...
      <el-table-column label="操作">
        <template v-slot="scope">
          ...
          <el-button type="warning" @click="handleChangePass(scope.row)">修改密码<i class="el-icon-edit-outline"></i></el-button>
          ...
          request.put('/admin/password', this.form).then(res => {
            if (res.code === '200') {
              ...
              if (this.form.id === this.admin.id) {
                //  如果当前修改的用户id是当前登录的管理员id，那么修改之后需要重新登录
